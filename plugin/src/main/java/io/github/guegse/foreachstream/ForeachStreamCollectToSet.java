...
public class ForeachStreamCollectToSet {
	...
	public static <T0, T1> Set<T1> stream_flatMap_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0) {
		HashSet<T1> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
	...
	public static <T0, T1, T2> Set<T2> stream_map_flatMap_collect_toSet(Collection<T0> input, Function<T0, T1> arg0, Function<T1, Collection<T2>> arg1) {
		HashSet<T2> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			T1 t1 = arg0.apply(t0);
	...
	public static <T0, T1> Set<T1> stream_filter_flatMap_collect_toSet(Collection<T0> input, Predicate<T0> arg0, Function<T0, Collection<T1>> arg1) {
		HashSet<T1> result = new HashSet<>();
		for (T0 t0 : input) {
			if (!arg0.test(t0)) {
				continue;
	...
	public static <T0, T1, T2> Set<T2> stream_flatMap_map_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, T2> arg1) {
		HashSet<T2> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				T2 t2 = arg1.apply(t1);
	...
	public static <T0, T1> Set<T1> stream_flatMap_filter_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Predicate<T1> arg1) {
		HashSet<T1> result = new HashSet<>();
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				if (!arg1.test(t1)) {
	...
	public static <T0, T1, T2> Set<T2> stream_flatMap_flatMap_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, Collection<T2>> arg1) {
		HashSet<T2> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				for (T2 t2 : arg1.apply(t1)) {
	...
	public static <T0, T1, T2, T3> Set<T3> stream_map_map_flatMap_collect_toSet(Collection<T0> input, Function<T0, T1> arg0, Function<T1, T2> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			T1 t1 = arg0.apply(t0);
			T2 t2 = arg1.apply(t1);
	...
	public static <T0, T1, T2> Set<T2> stream_map_filter_flatMap_collect_toSet(Collection<T0> input, Function<T0, T1> arg0, Predicate<T1> arg1, Function<T1, Collection<T2>> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			T1 t1 = arg0.apply(t0);
			if (!arg1.test(t1)) {
	...
	public static <T0, T1, T2, T3> Set<T3> stream_map_flatMap_map_collect_toSet(Collection<T0> input, Function<T0, T1> arg0, Function<T1, Collection<T2>> arg1, Function<T2, T3> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			T1 t1 = arg0.apply(t0);
			for (T2 t2 : arg1.apply(t1)) {
	...
	public static <T0, T1, T2> Set<T2> stream_map_flatMap_filter_collect_toSet(Collection<T0> input, Function<T0, T1> arg0, Function<T1, Collection<T2>> arg1, Predicate<T2> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			T1 t1 = arg0.apply(t0);
			for (T2 t2 : arg1.apply(t1)) {
	...
	public static <T0, T1, T2, T3> Set<T3> stream_map_flatMap_flatMap_collect_toSet(Collection<T0> input, Function<T0, T1> arg0, Function<T1, Collection<T2>> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			T1 t1 = arg0.apply(t0);
			for (T2 t2 : arg1.apply(t1)) {
	...
	public static <T0, T1, T2> Set<T2> stream_filter_map_flatMap_collect_toSet(Collection<T0> input, Predicate<T0> arg0, Function<T0, T1> arg1, Function<T1, Collection<T2>> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			if (!arg0.test(t0)) {
				continue;
	...
	public static <T0, T1> Set<T1> stream_filter_filter_flatMap_collect_toSet(Collection<T0> input, Predicate<T0> arg0, Predicate<T0> arg1, Function<T0, Collection<T1>> arg2) {
		HashSet<T1> result = new HashSet<>();
		for (T0 t0 : input) {
			if (!arg0.test(t0)) {
				continue;
	...
	public static <T0, T1, T2> Set<T2> stream_filter_flatMap_map_collect_toSet(Collection<T0> input, Predicate<T0> arg0, Function<T0, Collection<T1>> arg1, Function<T1, T2> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			if (!arg0.test(t0)) {
				continue;
	...
	public static <T0, T1> Set<T1> stream_filter_flatMap_filter_collect_toSet(Collection<T0> input, Predicate<T0> arg0, Function<T0, Collection<T1>> arg1, Predicate<T1> arg2) {
		HashSet<T1> result = new HashSet<>();
		for (T0 t0 : input) {
			if (!arg0.test(t0)) {
				continue;
	...
	public static <T0, T1, T2> Set<T2> stream_filter_flatMap_flatMap_collect_toSet(Collection<T0> input, Predicate<T0> arg0, Function<T0, Collection<T1>> arg1, Function<T1, Collection<T2>> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			if (!arg0.test(t0)) {
				continue;
	...
	public static <T0, T2, T3> Set<T3> stream_mapToInt_mapToObj_flatMap_collect_toSet(Collection<T0> input, ToIntFunction<T0> arg0, IntFunction<T2> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			int t1 = arg0.applyAsInt(t0);
			T2 t2 = arg1.apply(t1);
	...
	public static <T0, T3> Set<T3> stream_mapToInt_boxed_flatMap_collect_toSet(Collection<T0> input, ToIntFunction<T0> arg0, Function<Integer, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			int t1 = arg0.applyAsInt(t0);
			Integer t2 = t1;
	...
	public static <T0, T2, T3> Set<T3> stream_mapToLong_mapToObj_flatMap_collect_toSet(Collection<T0> input, ToLongFunction<T0> arg0, LongFunction<T2> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			long t1 = arg0.applyAsLong(t0);
			T2 t2 = arg1.apply(t1);
	...
	public static <T0, T3> Set<T3> stream_mapToLong_boxed_flatMap_collect_toSet(Collection<T0> input, ToLongFunction<T0> arg0, Function<Long, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			long t1 = arg0.applyAsLong(t0);
			Long t2 = t1;
	...
	public static <T0, T2, T3> Set<T3> stream_mapToDouble_mapToObj_flatMap_collect_toSet(Collection<T0> input, ToDoubleFunction<T0> arg0, DoubleFunction<T2> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			double t1 = arg0.applyAsDouble(t0);
			T2 t2 = arg1.apply(t1);
	...
	public static <T0, T3> Set<T3> stream_mapToDouble_boxed_flatMap_collect_toSet(Collection<T0> input, ToDoubleFunction<T0> arg0, Function<Double, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			double t1 = arg0.applyAsDouble(t0);
			Double t2 = t1;
	...
	public static <T0, T1, T2, T3> Set<T3> stream_flatMap_map_map_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, T2> arg1, Function<T2, T3> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				T2 t2 = arg1.apply(t1);
	...
	public static <T0, T1, T2> Set<T2> stream_flatMap_map_filter_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, T2> arg1, Predicate<T2> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				T2 t2 = arg1.apply(t1);
	...
	public static <T0, T1, T2, T3> Set<T3> stream_flatMap_map_flatMap_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, T2> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				T2 t2 = arg1.apply(t1);
	...
	public static <T0, T1, T2> Set<T2> stream_flatMap_filter_map_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Predicate<T1> arg1, Function<T1, T2> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				if (!arg1.test(t1)) {
	...
	public static <T0, T1> Set<T1> stream_flatMap_filter_filter_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Predicate<T1> arg1, Predicate<T1> arg2) {
		HashSet<T1> result = new HashSet<>();
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				if (!arg1.test(t1)) {
	...
	public static <T0, T1, T2> Set<T2> stream_flatMap_filter_flatMap_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Predicate<T1> arg1, Function<T1, Collection<T2>> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				if (!arg1.test(t1)) {
	...
	public static <T0, T1, T3> Set<T3> stream_flatMap_mapToInt_mapToObj_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, ToIntFunction<T1> arg1, IntFunction<T3> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				int t2 = arg1.applyAsInt(t1);
	...
	public static <T0, T1> Set<Integer> stream_flatMap_mapToInt_boxed_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, ToIntFunction<T1> arg1) {
		HashSet<Integer> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				int t2 = arg1.applyAsInt(t1);
	...
	public static <T0, T1, T3> Set<T3> stream_flatMap_mapToLong_mapToObj_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, ToLongFunction<T1> arg1, LongFunction<T3> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				long t2 = arg1.applyAsLong(t1);
	...
	public static <T0, T1> Set<Long> stream_flatMap_mapToLong_boxed_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, ToLongFunction<T1> arg1) {
		HashSet<Long> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				long t2 = arg1.applyAsLong(t1);
	...
	public static <T0, T1, T3> Set<T3> stream_flatMap_mapToDouble_mapToObj_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, ToDoubleFunction<T1> arg1, DoubleFunction<T3> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				double t2 = arg1.applyAsDouble(t1);
	...
	public static <T0, T1> Set<Double> stream_flatMap_mapToDouble_boxed_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, ToDoubleFunction<T1> arg1) {
		HashSet<Double> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				double t2 = arg1.applyAsDouble(t1);
	...
	public static <T0, T1, T2, T3> Set<T3> stream_flatMap_flatMap_map_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, Collection<T2>> arg1, Function<T2, T3> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				for (T2 t2 : arg1.apply(t1)) {
	...
	public static <T0, T1, T2> Set<T2> stream_flatMap_flatMap_filter_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, Collection<T2>> arg1, Predicate<T2> arg2) {
		HashSet<T2> result = new HashSet<>();
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				for (T2 t2 : arg1.apply(t1)) {
	...
	public static <T0, T1, T2, T3> Set<T3> stream_flatMap_flatMap_flatMap_collect_toSet(Collection<T0> input, Function<T0, Collection<T1>> arg0, Function<T1, Collection<T2>> arg1, Function<T2, Collection<T3>> arg2) {
		HashSet<T3> result = new HashSet<>(input.size());
		for (T0 t0 : input) {
			for (T1 t1 : arg0.apply(t0)) {
				for (T2 t2 : arg1.apply(t1)) {
